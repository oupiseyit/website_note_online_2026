...
2. **Screenshot** the rendered page at 1440px desktop width:
   `npx -y capture-website-cli index.html --full-page --width=1440 --output=screenshot/shot.png --overwrite`
   If the page has distinct sections, capture those individually too. Save all screenshots in `screenshot/`.
